...
public class MainActivity extends AppCompatActivity {
    ...
    final private static int notificationId = 101;
    final private static String KEY_TEXT_REPLY = "key_text_reply";
    private NotificationManager notificationManager;
    final private String channelID = "com.ebookfrenzy.directreply.news";
